...
async def generate_proposals(state: GraphState) -> tuple[list[ProposalDraft], list[dict[str, Any]], int]:
    ...
    llm_turns.append({"phase": "propose", "turn_index": 1, "role": "assistant", "content": response.text})
    ...
    try:
        ...
        return [ProposalDraft(
            ...
            source='plugin',
        ) for p in proposals], llm_turns, total_tokens
